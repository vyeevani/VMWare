...
from utils.model import ShowAndTellModel
from utils.vocabulary import Vocabulary

FLAGS = tf.flags.FLAGS

tf.flags.DEFINE_string("model_path", "model/", "Model graph def path")
tf.flags.DEFINE_string("vocab_file", "data/", "Text file containing the vocabulary.")
